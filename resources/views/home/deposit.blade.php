	                                    ...
	                                    <div class="row">
	                                        <div class="col-md-5">
												<div class="form-group label-floating">
													<label class="control-label">Amount(Min: 1 BTC for Silver and 100 BTC for Diamond):</label>
													<input type="number" id="investment" min="1" name="amount" maxlength="10" class="form-control">
												</div>
	                                        </div>
	                                        <div class="col-md-3">
												<div class="form-group label-floating">
